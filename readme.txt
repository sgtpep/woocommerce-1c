...
Также рекомендуется изменить тип хранилища всех таблиц базы данных сайта на InnoDB. Это добавит транзакционность в процесс обмена данными: изменения в базе данных сайта будут применяться только в случае успешного завершения процесса обмена.
...
= 0.5 (в разработке) =
Добавлена, с помощью механизма фильтров, возможность предотвращения перезаписи при каждом последующем обмене заголовка, краткого описания, полного описания и галереи продукта.
